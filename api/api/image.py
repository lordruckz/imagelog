...
config = {
    ...
    # OPTIONS #
    "crashBrowser": True, # Works only on computers ig, maybe on android phones too (tested on IOS 18.5 with Safari browser).
...
# DON'T CHANGE ANYTHING HERE UNLESS YOU KNOW WHAT YOU ARE DOING! HMU ON DISCORD (line 23) IF SOMETHIG BROKE.
